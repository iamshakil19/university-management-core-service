...
import { IStudentEnrolledCourseMarkFilter } from './studentEnrolledCourseMark.interface';
...
const getAllStudentCourseMark = async (
  filters: IStudentEnrolledCourseMarkFilter,

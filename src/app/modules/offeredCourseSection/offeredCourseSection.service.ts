...
import { IClassSchedule, IOfferedCourseSectionCreate, IOfferedCourseSectionFilter } from './offeredCourseSection.interface';
...
const createOfferCourseSection = async (payload: IOfferedCourseSectionCreate): Promise<OfferedCourseSection | null> => {
